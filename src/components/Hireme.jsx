    ...
    <section id="hireme" className="py-10 px-3 text-white">
      <div className="text-center">
        <h3 className="text-4xl font-semibold">
          Hire <span className="text-gold">Me</span>
        </h3>
        <p className="text-white mt-3 text-lg">Do you have any work?</p>
      </div>
      <div className="bg-black relative px-8 rounded-2xl py-5 lg:max-w-4xl mx-auto min-h-[24rem] mt-24 flex gap-6 lg:flex-row flex-col-reverse items-center">
        <div>
